...
- **Suite connection:** Once this chain produces your talk outline, use [ai-bu-slide-outliner](https://github.com/MarkellR-RedHat/ai-bu-slide-outliner) to build the slide deck and [ai-bu-cfp-generator](https://github.com/MarkellR-RedHat/ai-bu-cfp-generator) to polish the CFP submission. If you use `ai-bu-claude-commands`, the `/blog-from-pr` slash command can generate the blog post that feeds into this chain, and the `/demo-prep` slash command can build the live demo portion of the resulting talk.
