...
- **Related tool:** For daily context rather than specific meeting prep, use [daily-briefing](https://github.com/MarkellR-RedHat/daily-briefing). The daily briefing gives you a broad view of what happened overnight; this prompt gives you deep preparation for a specific meeting. If you use `claude-commands`, the `/what-next` slash command can help prioritize action items that come out of the meeting you prepared for.
