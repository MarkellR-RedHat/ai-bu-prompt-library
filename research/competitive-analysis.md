...
- **Related tool:** If you use `claude-commands`, the `/competitive-snapshot` slash command provides a lighter-weight version of this analysis for quick competitor questions in meetings. This prompt is for the deep one-off dive.
