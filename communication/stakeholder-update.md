...
- **Related tool:** If you use `claude-commands`, the `/draft-announcement` slash command can generate stakeholder-facing announcements, and the `/release-notes` slash command handles release-specific status communication.
