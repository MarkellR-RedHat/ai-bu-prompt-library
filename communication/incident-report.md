...
- **Slash command connection:** If you use `claude-commands`, the `/retro` slash command generates retrospectives from repo activity, and the `/summarize-thread` slash command can extract incident data from long discussion threads.
